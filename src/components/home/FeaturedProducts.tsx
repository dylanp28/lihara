          ...
          <AnimatedSection className="lg:col-span-7">
            <Link href={`/products/${hero.slug}`} className="group block">
              <div className="overflow-hidden">
                <MediaSlot
                  label={`${hero.name} — featured product image`}
                  ratio=""
                  className="!h-[30rem] sm:!h-[38rem] transition-transform duration-[900ms] ease-out group-hover:scale-[1.03] rounded-none"
                />
              </div>
              <div className="mt-5 flex items-start justify-between">
                ...
                <span className="text-base text-charcoal/50 font-light mt-1">
                ...
                <Link href={`/products/${product.slug}`} className="group block">
                  <div className="overflow-hidden">
                    <MediaSlot
                      ...
                      ratio=""
                      className="!h-48 sm:!h-[17.5rem] transition-transform duration-[900ms] ease-out group-hover:scale-[1.03] rounded-none"
                    />
                  </div>
                  <div className="mt-4 flex items-start justify-between">
                    ...
                    <span className="text-sm text-charcoal/40 font-light">
